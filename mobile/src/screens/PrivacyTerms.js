...
const PrivacyTerms = ({ navigation, route }) => {
    ...
    const source = {
        html: `${route.params.type == "terms" ? TermsHtml : PolicyHTML}`
    };
    return (
        <View style={{ flex: 1 }}>
            <CustomHeader
...
<p>
Abdü Samed Akgül built the Vocan app as
a Free app. This SERVICE is provided by
Abdü Samed Akgül at no cost and is intended for use as
is.
</p>
<p>
...
Vocan unless otherwise defined in this Privacy Policy.
</p>
<p><strong>Information Collection and Use</strong></p>
<p>
For a better experience, while using our Service, I
may require you to provide us with certain personally
identifiable information, including but not limited to Email, username, password. The information that
...
<p>This policy is effective as of 2022-09-08</p>
<p><strong>Contact Us</strong></p>
<p>
If you have any questions or suggestions about my
Privacy Policy, do not hesitate to contact me at samedakgul99@gmail.com.
</p>
...
to it, still belong to Abdü Samed Akgül.
</p>
<p>
Abdü Samed Akgül is committed to ensuring that the app is
...
<p>
The Vocan app stores and processes personal data that
...
that the Vocan app won’t work properly or at all.
</p>
<div>
<p>
...
Abdü Samed Akgül will not take responsibility for. Certain
functions of the app will require the app to have an active
internet connection. The connection can be Wi-Fi or provided
by your mobile network provider, but Abdü Samed Akgül
...
<p>
Along the same lines, Abdü Samed Akgül cannot always take
responsibility for the way you use the app i.e. You need to
make sure that your device stays charged – if it runs out of
battery and you can’t turn it on to avail the Service,
Abdü Samed Akgül cannot accept responsibility.
</p>
<p>
With respect to Abdü Samed Akgül’s responsibility for your
use of the app, when you’re using the app, it’s important to
bear in mind that although we endeavor to ensure that it is
updated and correct at all times, we do rely on third parties
to provide information to us so that we can make it available
to you. Abdü Samed Akgül accepts no liability for any
...
using the app. Abdü Samed Akgül does not promise that it
